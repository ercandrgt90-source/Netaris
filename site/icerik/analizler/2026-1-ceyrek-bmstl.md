...
| Aktif toplamı | %19,1 |
| Net borç | -%27,8 |
| Faaliyet nakit akışı | -%232,5 |
| Yatırım harcaması | %14,7 |
...
| --- | ---: | ---: |
| Brüt kâr marjı | %22,7 | %14,1 |
| Net kâr marjı | %2,5 | -%0,2 |
| Özkaynak kârlılığı | %1,3 | -%0,1 |
| Cari oran | 1,32 | 1,36 |
| Borç / özkaynak | 0,29 | 0,21 |
...
- Hasılat reel olarak %26,2 arttı.
- Net kâr reel olarak %71,4 arttı.
- Brüt marj 4,3 puan genişledi (%16,1 → %20,4).
